 ...
 */
class SupportAdmin extends Authenticatable implements CanActivateContract, HasMedia
{
    use Notifiable;
    use CanActivate;
    use SoftDeletes;
    ...
    protected $appends = ['full_name', 'resource_url','avatar_thumb_url','ceo_url','support_url','chats_count'];
    ...
    public function getResourceUrlAttribute()
    {
        ...
        return url('/admin/support-admin/' . $this->getKey());
    }
    public function getCeoUrlAttribute()
    {   
        return url('/ceo/support-admin/'.$this->getKey());
    }
    public function getSupportUrlAttribute()
    {   
        return url('/support/support-admin/'.$this->getKey());
    }
    /**
    ...
    {
        return str_replace('media','public/media',$this->getFirstMediaUrl('avatar', 'thumb_150')) ?: null;
    }
    ...
    {
        return $this->morphMany('App\Models\Chat', 'sender');
    }
    ...
    public function getChatsCountAttribute(){
        $chats=$this->chats;
       return $chats->count();
    }
}
