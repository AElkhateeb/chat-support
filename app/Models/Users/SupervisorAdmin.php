 ...
 */
class SupervisorAdmin extends Authenticatable implements CanActivateContract, HasMedia
{
    use Notifiable;
    use CanActivate;
    use SoftDeletes;
    ...
    {
        return url('/admin/supervisor-admin/' . $this->getKey());
    }
    ...
    {
        return $this->getFirstMediaUrl('avatarSupervisor', 'thumb_150') ?: null;
    }
    ...
    {
        $this->addMediaCollection('avatarSupervisor')
            ->accepts('image/*');
    }
    ...
    public function registerMediaConversions(Media $media = null): void
    {
        ...
        $this->addMediaConversion('thumb_75')
            ...
            ->fit('crop', 75, 75)
            ->optimize()
            ->performOnCollections('avatarSupervisor')
            ->nonQueued();
