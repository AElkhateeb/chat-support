...
class CeoAdmin extends Authenticatable implements CanActivateContract, HasMedia
{
    ...
    protected $appends = ['full_name', 'resource_url','avatar_thumb_url','ceo_url','support_url'];
    ...
    public function getResourceUrlAttribute()
    {
        ...
        return url('/admin/ceo-admin/' . $this->getKey());
    }
    public function getCeoUrlAttribute()
    {   
        return url('/ceo/ceo-admin/'.$this->getKey());
    }
    public function getSupportUrlAttribute()
    {   
        return url('/support/ceo-admin/'.$this->getKey());
    }
