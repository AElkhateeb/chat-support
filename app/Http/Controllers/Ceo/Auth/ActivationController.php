...
class ActivationController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $activationBroker = 'ceo_admins';
    ...
    public function __construct()
    {
        ...
        $this->activationBroker = config('ceo-auth.defaults.activations');
        $this->redirectTo = config('ceo-auth.activation_redirect');
    ...
    protected function sendActivationFailedResponse(Request $request, string $response)
    {
        ...
        if (config('ceo-auth.self_activation_form_enabled')) {
