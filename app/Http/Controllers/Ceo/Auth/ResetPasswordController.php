...
class ResetPasswordController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $passwordBroker = 'ceo_admins';
    ...
    public function __construct()
    {
        ...
        $this->passwordBroker = config('ceo-auth.defaults.passwords');
        $this->redirectTo = config('ceo-auth.password_reset_redirect');
    ...
    {
        return view('ceo.auth.passwords.reset')->with(
