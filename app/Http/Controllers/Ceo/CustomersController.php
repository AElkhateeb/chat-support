...
class CustomersController extends Controller
{
    ...
    public function index(IndexCustomer $request)
    {
        ...
        return view('ceo.customer.index', ['data' => $data]);
    }
    ...
    {
        $this->authorize('ceo.customer.create');

        return view('ceo.customer.create');
    }
    ...
    public function store(StoreCustomer $request)
    {
        ...
        if ($request->ajax()) {
            return ['redirect' => url('ceo/customers'), 'message' => trans('brackets/admin-ui::admin.operation.succeeded')];
        }

        return redirect('ceo/customers');
    }
    ...
    {
        $this->authorize('ceo.customer.show', $customer);
    ...
    {
        $this->authorize('ceo.customer.edit', $customer);


        return view('ceo.customer.edit', [
            'customer' => $customer,
        ]);
    }
