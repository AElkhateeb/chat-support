...
class RepliesController extends Controller
{
    ...
    public function index(IndexReply $request)
    {
        ...
        return view('support.reply.index', ['data' => $data]);
    }
    ...
    {
        $this->authorize('support.reply.create');

        return view('support.reply.create', [
    ...
    public function store(StoreReply $request)
    {
        ...
        if ($request->ajax()) {
            return ['redirect' => url('support/replies'), 'message' => trans('brackets/admin-ui::admin.operation.succeeded')];
        }

        return redirect('support/replies');
    }
    ...
    {
        $this->authorize('support.reply.show', $reply);
    ...
    {
        $this->authorize('support.reply.edit', $reply);

        $reply->load('pattern');
       
        return view('support.reply.edit', [
            'reply' => $reply,
