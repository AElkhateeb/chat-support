...
class MessagesController extends Controller
{
    ...
    public function index(IndexMessage $request)
    {
        ...
        return view('support.message.index', ['data' => $data]);
    }
    ...
    {
        $this->authorize('support.message.create');

        return view('support.message.create');
    }
    ...
    public function store(StoreMessage $request)
    {
        ...
        if ($request->ajax()) {
            return ['redirect' => url('support/messages'), 'message' => trans('brackets/admin-ui::admin.operation.succeeded')];
        }
    ...
    {
        $this->authorize('support.message.show', $message);
    ...
    {
        $this->authorize('support.message.edit', $message);


        return view('support.message.edit', [
            'message' => $message,
        ]);
    }
