...
class CustomersController extends Controller
{
    ...
    public function index(IndexCustomer $request)
    {
        ...
        return view('support.customer.index', ['data' => $data]);
    }
    ...
    {
        $this->authorize('support.customer.create');
    ...
    public function store(StoreCustomer $request)
    {
        ...
        if ($request->ajax()) {
            return ['redirect' => url('support/customers'), 'message' => trans('brackets/admin-ui::admin.operation.succeeded')];
        }

        return redirect('support/customers');
    }
    ...
    {
        $this->authorize('support.customer.show', $customer);
    ...
    {
        $this->authorize('support.customer.edit', $customer);


        return view('support.customer.edit', [
            'customer' => $customer,
        ]);
    }
    ...
    public function update(UpdateCustomer $request, Customer $customer)
    {
        ...
        if ($request->ajax()) {
            return [
                'redirect' => url('support/customers'),
