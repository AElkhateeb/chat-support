...
class ResetPasswordController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $passwordBroker = 'support_admins';
    ...
    public function __construct()
    {
        ...
        $this->passwordBroker = config('support-auth.defaults.passwords');
        $this->redirectTo = config('support-auth.password_reset_redirect');
