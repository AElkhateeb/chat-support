...
class ActivationEmailController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $activationBroker = 'department_admins';
    ...
    public function __construct()
    {
        ...
        $this->activationBroker = config('support-auth.defaults.activations');
    ...
    {
        if (config('support-auth.self_activation_form_enabled')) {
            return view('support.auth.activation.email');
        } else {
            abort(404);
        }
    }
