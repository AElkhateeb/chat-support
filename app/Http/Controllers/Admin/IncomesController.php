...
class IncomesController extends Controller
{
    ...
    public function index(IndexIncome $request)
    {
        ...
        return view('admin.income.index', ['data' => $data]);
    }
    ...
    {
        $this->authorize('admin.income.create');
    ...
    public function store(StoreIncome $request)
    {
       ...
       // $sanitized = $request->getSanitized();
        ...
        if ($request->ajax()) {
            return ['redirect' => url('admin/incomes'), 'message' => trans('brackets/admin-ui::admin.operation.succeeded')];
        }
    ...
    {
        $this->authorize('admin.income.show', $income);
    ...
    {
        $this->authorize('admin.income.edit', $income);
