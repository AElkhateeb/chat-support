...
class FillPermissionsForBootAdmin extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.boot-admin',
            'admin.boot-admin.index',
            'admin.boot-admin.create',
            'admin.boot-admin.show',
            'admin.boot-admin.edit',
            'admin.boot-admin.delete',
            'admin.boot-admin.bulk-delete',
        ]);
