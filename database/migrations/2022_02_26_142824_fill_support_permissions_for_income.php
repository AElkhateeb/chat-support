...
class FillSupportPermissionsForIncome extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForIncome constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'support.income',
            'support.income.index',
            'support.income.create',
            'support.income.show',
            'support.income.edit',
            'support.income.delete',
            'support.income.bulk-delete',
        ]);
