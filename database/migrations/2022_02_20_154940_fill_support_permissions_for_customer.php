...
class FillSupportPermissionsForCustomer extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'support.customer',
            'support.customer.index',
            'support.customer.create',
            'support.customer.show',
            'support.customer.edit',
            'support.customer.delete',
            'support.customer.bulk-delete',
        ]);
