...
/**
 * Class FillDefaultCeoAdminAndPermissions
 */
class FillDefaultCeoAdminAndPermissions extends Migration
{
    /**
    ...
    /**
     * FillDefaultCeoAdminAndPermissions constructor.
     */
    public function __construct()
    {
        ...
        $defaultPermissions = collect([
            ...
            // manage users (access)
            'ceo.ceo-admin.index',
            'ceo.ceo-admin.create',
            'ceo.ceo-admin.edit',
            'ceo.ceo-admin.delete',

            // ability to upload
            'ceo.upload',

            //ability to impersonal login
            'ceo.ceo-admin.impersonal-login'
        ]);
    ...
    public function up(): void
    {
        if ($this->userClassName === null) {
            throw new RuntimeException('Ceo user model not defined');
        }
