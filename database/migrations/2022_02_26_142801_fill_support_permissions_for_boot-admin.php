...
class FillSupportPermissionsForBootAdmin extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBootAdmin constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'support.boot-admin',
            'support.boot-admin.index',
            'support.boot-admin.create',
            'support.boot-admin.show',
            'support.boot-admin.edit',
            'support.boot-admin.delete',
            'support.boot-admin.bulk-delete',
        ]);
