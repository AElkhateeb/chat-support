            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-sm pull-right m-b-0" href="{{ url('support/translations/rescan') }}"
                           @click.prevent="rescan('{{ url('support/translations/rescan') }}')" role="button"><i class="fa"
                    ...
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary" href="{{ url('support/translations/rescan') }}"
                                    @click.prevent="rescan('{{ url('support/translations/rescan') }}')" role="button"><i
